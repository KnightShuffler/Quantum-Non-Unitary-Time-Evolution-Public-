...
[Published in Nature Scientific Reports](https://www.nature.com/articles/s41598-025-97245-3)

The results in our paper can be generated by running the run_test module in tests/black_scholes with the provided json file with the following command:

`python -m tests.black_scholes.run_test`

# Citation
```
@article{kumar2025simulating,
  title={Simulating the non-Hermitian dynamics of financial option pricing with quantum computers},
  author={Kumar, Swagat and Wilmott, Colin Michael},
